		...
		try {
...

			{
				final var response = client
					.target("https://localhost:8081/api/first/processXML?input=test")
				...
				final var entity = response.readEntity(
					com.antonyudin.restful.services.first.jakarta.Service.OutputXML.class
				);
			...
			{
				final var response = client
					.target("https://localhost:8081/api/first/processJSON?input=test")
				...
				final var entity = response.readEntity(
					com.antonyudin.restful.services.first.jakarta.Service.OutputJSON.class
				);
